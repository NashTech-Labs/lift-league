...
class Boot {
  def boot {
    ...
    Schemifier.schemify(true, Schemifier.infoF _, User,Team,Player)
    ...
    val entries = List(
      ...
      Menu(Loc("Static", Link(List("static"), true, "/static/index"), 
	       "Static Content")))::: User.menus::: Team.menus ::: Player.menus
   ...
   object Database extends StandardDBVendor(
    ...
    Props.get("db.url").openOr("jdbc:mysql://localhost:3306/league;FILE_LOCK=NO"),
    Props.get("db.user"),
